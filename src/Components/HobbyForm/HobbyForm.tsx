...
const UserForm:  React.FC<{ addHobbiesFunc: any }> = ({ addHobbiesFunc }) => {
    ...
    const UserForm = <div className="userHobbyAddform">
                        ...
                        <button onClick={(e) => addHobbiesFunc(e, hobby,year,passion)}>Add</button>
                </div>
    return UserForm;
};
